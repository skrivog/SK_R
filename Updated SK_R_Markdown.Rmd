...
ggplot(snp_counts, aes(x = as.numeric(Chromosome), y = SNP_Count, fill = Chromosome)) +
...
snp_counts_teosinte <- as.data.frame(table(teo_df_sorted$Chromosome))
 ...
 ggplot(snp_counts_teosinte, aes(x = as.numeric(Chromosome), y = SNP_Count, fill = Chromosome)) +
