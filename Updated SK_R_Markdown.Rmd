...
graph1 <- ggplot(snp_counts, aes(x = as.numeric(Chromosome), y = SNP_Count, fill = Chromosome)) +
...
graph2 <- ggplot(snp_counts_teosinte, aes(x = as.numeric(Chromosome), y = SNP_Count, fill = Chromosome)) +
...
graph3 <- ggplot(snp_comparison, aes(x = Chromosome, y = SNP_Count, fill = Species)) +
...
graph4 <- ggplot(maize_df_sorted, aes(x = as.numeric(Position))) +
...
graph5 <- ggplot(teo_df_sorted, aes(x = as.numeric(Position))) +
    geom_density(fill = "blue", alpha = 0.5) +
